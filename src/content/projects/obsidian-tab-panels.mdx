...
shortDescription: Obsidian plugin to create tab panels to organize content into sections # Used in project card. 10-20 words
...
## Preview
![Preview](../../images/webdev/ObsidianTabPanels/Preview.gif)