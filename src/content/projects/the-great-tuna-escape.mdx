...
# githubLink: 
thumbnailImg: "../../images/gamedev/TheGreatTunaEscape/TheGreatTunaEscape_Thumbnail2.png"
rank: 100
tags: [Unity, GameJam, Windows, WebGL, Completed]

---
import ItchGameEmbed from "../../components/ItchGameEmbed.astro";
...
## Game Overview
The player keeps escaping from a diver who's trying to catch them. There are plastic bags littered in the ocean. When the player hits a bag, they'll get slowed down. 
...
## Gameplay Loop
![Gameplay Loop](../../images/TheGreatTunaEscape/TheGreatTunaEscape_GameplayLoop.png)
