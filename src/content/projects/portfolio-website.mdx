...
import EasyToAddProjectExample from "../../images/webdev/PortfolioWebsite/EasyToAddProjectExample.png";
import UnlighthouseResult from "../../images/webdev/PortfolioWebsite/UnlighthouseResult.png";
...
<ExpandImgOnClick image={EasyToAddProjectExample} alt="Easy to add project example" />
...
### Fast to load
<ExpandImgOnClick image={UnlighthouseResult} alt="Unlighthouse Scan Result" />
